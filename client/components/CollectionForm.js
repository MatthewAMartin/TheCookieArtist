...
import {
  ...
  getCollectionCookiesAPI,
  getCollectionImagesAPI,
  getLatestCollectionIDAPI,
  postCollectionAPI,
  postCollectionCookieAPI,
  postCollectionImageAPI,
  putCollectionAPI,
  putCollectionCookieAPI,
  deleteCollectionAPI,
  deleteCollectionCookieAPI,
  deleteCollectionImageAPI,
} from "../pages/api/collectionsAPI";
import { getAllCookiesAPI } from "../pages/api/cookiesAPI";
import EmblaCarousel from "./EmblaCarousel";

const CollectionForm = (form, closeForm) => {
  // Component Variables
  ...
  const [collectionActiveStatus, setCollectionActiveStatus] = useState(1);
  ...
  //     setCollectionName("");
  //     setCollectionCost("");
  //     setCollectionActiveStatus(1);
  //     setStoredImageURLs([]);
  //   } else {
  //     // Initialise the form and variables to the first record in the list
  //     setSelectedCollection(0);
  //     setCollectionId(initCookieId);
  //     setCollectionName(initName);
  //     setCollectionCost(initCost);
  //     setCollectionActiveStatus(initActiveStatus);
  ...
  //   setCollectionId(collectionsArr[index].cookie_id);
  //   setCollectionName(collectionsArr[index].name);
  //   setCollectionCost(collectionsArr[index].cost);
  //   setCollectionActiveStatus(collectionsArr[index].active_status);
  //   getCookieImages(collectionsArr[index].cookie_id);
  ...
  //  *
  //  * @return {*} An array containing the results of the validity check [collectionName (bool), collectionCost (bool)].
  //  */
  // const validateForm = () => {
  //   let validName = false;
  //   let validCost = false;

  //   // Validate collectionName Input
  //   if (collectionName !== "" && collectionName !== undefined) {
  //     validName = true;
  //   }

  //   // Validate collectionCost Input
  //   if (!isNaN(parseFloat(collectionCost))) {
  //     validCost = true;
  //   }
  ...
  //  * with that all of that data (initialising the selectedCollection
  ...
  //   let APIBody = `{"name": "${collectionName}", "cost": ${collectionCost}, "active_status": ${collectionActiveStatus}}`;
  ...
  //   // Initialise the body of the API call
  //   let APIBody = `{"cookie_id": "${collectionId}", "name": "${collectionName}", "cost": ${collectionCost}, "active_status": ${collectionActiveStatus}}`;
  ...
  //   for (let i = 0; i < localImages.length; i++) {
  //     // Upload the local Image file
  //     const imageResponse = await uploadLocalImage(collectionId, i);
  //   }
  ...
  //   // Initialise the body of the API call
  //   let APIBody = `{"cookie_id": ${collectionId}}`;
  ...
  return (
    <>
      <div className="container center form-card">
        ...
        />
        <p>Use the form below to manage your Cookie collections.</p>
        <div
        ...
        <form>
          ...
          <div className="row mb-3">
            <label htmlFor="collectionName" className="col-sm-2 col-form-label">
              Name:
            </label>
          ...
          <div className="row mb-3">
            <label htmlFor="collectionCost" className="col-sm-2 col-form-label">
              Cost:
            </label>
            <div className="col-sm-10 ">
              <input
          ...
          <div className="row mb-3">
            ...
            <div className="col-sm-10 ">
              <select
                className="form-select"
                id="cookieStatus"
                value={collectionActiveStatus}
                onChange={(e) => setCollectionActiveStatus(e.target.value)}
                style={{
                  pointerEvents: isInput ? "auto" : "none",
                  backgroundColor: isInput ? "#FFFFFF" : "#DCDCDC",
                  color: isInput ? "#000000" : "#696969",
